...
import { experience as experiences } from "../data";
...
export function Experience() {
  ...
  function isScrolledIntoView(elem) {
    var docViewTop = document.querySelector(`.${styles.parent}`).scrollTop;
    var docViewBottom =
      docViewTop + document.querySelector(`.${styles.parent}`).offsetHeight;
  ...
  useEffect(() => {
    ...
    const updateTimeline = () => {
      try {
        ...
        var winScroll = document.querySelector(`.${styles.parent}`).scrollTop;
        var height =
    ...
    // console.log(document.querySelector(`.${styles.parent}`));

    document
      .querySelector(`.${styles.parent}`)
