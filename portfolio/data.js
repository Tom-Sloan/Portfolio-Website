...
const portfolioData = {
	...
	projects: [
		...
		},
		{
			...
			description:
				"A hardware + software gaming peripheral that displays in-game hotbar items as floating holograms inside physical glass prism cubes on your desk. 9 miniature K9 beamsplitter prisms sit on a custom 3D-printed enclosure driven by an ESP32-S3 with 9x 1.3\" IPS displays creating a Pepper's Ghost effect. AI-powered screen capture with a custom-trained YOLOv11n (1,771 self-labeled screenshots, 30+ games) detects the hotbar in any PC game, segments slots via multi-strategy OpenCV pipeline, and transmits identified items over USB-C serial at ~10 FPS per display.",
			...
			image: "images/projects/pixelbar.png",
			link: null,
			featured: true,
		},
		{
