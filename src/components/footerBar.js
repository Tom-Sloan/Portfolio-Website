...
export function Footer () {
    return (
        <div className={styles.footer} >
            <Link className={styles.headerLink} to="/contact"><FontAwesomeIcon className={styles.footerIcons} icon={faLinkedin} /></Link>
            <Link className={styles.headerLink} to="/contact"><FontAwesomeIcon className={styles.footerIcons} icon={faGithubSquare} /></Link>
