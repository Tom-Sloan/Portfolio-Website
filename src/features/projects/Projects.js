...
export function Projects() {
    ...
    function isScrolledIntoView(elem) {
        var docViewTop = document.querySelector(`.${bodyStyle.parallaxParent}`).scrollTop;
                            ...
                            projects.map((data, idx) => (
                                <div className={styles.timelineItem}>
                                    <div className={styles.timelineContent}>
                                        <a href={`#data ${idx}`} className={styles.circleLink} onMouseEnter={handleHover} onMouseLeave={handleNoHover} >
                            ...
                            projects.map((data, idx) => (
                                <div className={styles.project} id={`data ${idx}`} >
                                    <h2>
                                        {data.title}
                                        {data.link && (
                                            <a href={data.link} target="_blank" rel="noopener noreferrer" className={styles.linkData} >
                                    ...
                                    <h3>{data.subtitle}</h3>
                                    {data.image && <img src={data.image} alt="" onLoad={updateWindowDimensions} />}
